...
export class Card extends Component<ICard> {
  ...
  constructor(protected blockName: string, container: HTMLElement, actions?: ICardActions) {
    ...
    this._category = ensureElement<HTMLTextAreaElement>(`.${blockName}__category`, container);
    this._price = ensureElement<HTMLTextAreaElement>(`.${blockName}__price`, container);
